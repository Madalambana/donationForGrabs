...
public class Register extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("DonationForGrabs");

        jLabel11.setFont(new java.awt.Font("Segoe UI", 2, 12)); // NOI18N
        jLabel11.setText("Together we are one!");
...
this.dispose();        // TODO add your handling code here:
 ...
 String Username=jTextField1.getText();
        ...
        String KinsNo = jTextField6.getText();
        String Password=jTextField7.getText();
        String ConPassword=jTextField8.getText();
        if (Username.trim() == "" || Name.trim() == ""|| Surname.trim() == "" || Address.trim() == "" 
                || ContactNo.trim() == "" || KinsNo.trim() == ""|| Password == "" ){
...
try {
            ...
            PreparedStatement ps=con.prepareStatement("insert into users (username,"
                    + " name, surname, address, ContactNo,kinsNo, password, conPassword) values(?,?,?,?,?,?,?,?)");
            ps.setString(1,Username);
            ps.setString(2,Name);
            ps.setString(3, Surname);
            ps.setString(4,Address);
            ps.setString(5,ContactNo);
            ps.setString(6,KinsNo);
            ps.setString(7,Password);
            ps.setString(8, ConPassword);
            ps.executeUpdate();
